...
TOOLS: list[ToolDefinition] = [
    ...
    ToolDefinition(
        ...
        description="Compress image to under 5KB file size for forms that require tiny images.",
        category="image-core",
        tags=["compress", "5kb", "small", "image"],
        input_kind="files",
    ),
    ToolDefinition(
        slug="compress-to-10kb",
        title="Compress to 10KB",
        description="Compress image to under 10KB for minimal upload requirements.",
        category="image-core",
        tags=["compress", "10kb", "image"],
        input_kind="files",
    ),
    ToolDefinition(
        slug="compress-to-20kb",
        title="Compress to 20KB",
        description="Compress image to under 20KB for exam and application forms.",
        category="image-core",
    ...
    ToolDefinition(
        ...
        description="Compress image to under 50KB for common upload limits.",
        category="image-core",
    ...
    ToolDefinition(
        ...
        description="Compress image to under 100KB for web use.",
        category="image-core",
    ...
    ToolDefinition(
        ...
        description="Compress image to under 200KB for email attachments and web forms.",
        category="image-core",
    ...
    ToolDefinition(
        ...
        description="Compress image to under 500KB while maintaining good visual quality.",
        category="image-core",
        tags=["compress", "500kb", "image"],
        input_kind="files",
    ),
    ToolDefinition(
        slug="compress-to-1mb",
        title="Compress to 1MB",
        description="Compress image to under 1MB for general use and uploads.",
        category="image-core",
    ...
    ToolDefinition(
        ...
        title="Compress to 30KB",
        description="Compress image to under 30KB for compact applications.",
        category="image-core",
        tags=["compress", "30kb", "image"],
        input_kind="files",
    ),
    ToolDefinition(
    ...
    ToolDefinition(
        ...
        description="Compress image to under 150KB for balanced quality and size.",
        category="image-core",
        tags=["compress", "150kb", "image"],
        input_kind="files",
    ),
    ToolDefinition(
        slug="compress-to-300kb",
        title="Compress to 300KB",
        description="Compress image to under 300KB for high-quality uploads.",
        category="image-core",
        tags=["compress", "300kb", "image"],
        input_kind="files",
    ),
    ToolDefinition(
        slug="compress-to-2mb",
        title="Compress to 2MB",
        description="Compress image to under 2MB while preserving detail.",
        category="image-core",
