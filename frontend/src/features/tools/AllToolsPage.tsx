...
export default function AllToolsPage() {
  ...
  useEffect(() => {
    applyDocumentBranding(
      'All Tools — 622+ Free Online Tools | ISHU TOOLS',
      'Browse all 622+ free online tools. PDF tools, image tools, developer tools, math calculators, text tools, and more. No signup, no watermark.',
      '#3bd0ff',
    )

    // SEO meta
    const desc = document.querySelector('meta[name="description"]')
    if (desc) desc.setAttribute('content', 'Browse all 622+ free online tools at ISHU TOOLS. PDF merge, compress, convert, image resize, developer tools, calculators, and more. No signup, no watermark, free forever.')
