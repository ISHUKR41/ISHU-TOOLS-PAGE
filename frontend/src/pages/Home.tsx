...
const stats = [
  { value: '715+', label: 'Free Tools', icon: Sparkles },
...
const comparisons = [
  ...
  { feature: '715+ Tools', ishu: true, ilovepdf: false, smallpdf: false, canva: false },
...
const homeFaqs = [
  { q: 'What is ISHU TOOLS?', a: 'ISHU TOOLS (Indian Student Hub University Tools) is a free online platform with 715+ tools for PDF processing, image editing, developer utilities, math calculators, text operations, and AI-powered features. Created by Ishu Kumar (IIT Patna student), it is designed for Indian students and professionals — no signup, no watermark, completely free.' },
  { q: 'Is ISHU TOOLS completely free?', a: 'Yes! ISHU TOOLS is 100% free. All 715+ tools are available without any signup, registration, or payment. No watermarks, no daily limits, no hidden charges. Free forever — that\'s the ISHU promise.' },
  ...
  { q: 'Is ISHU TOOLS better than iLovePDF or SmallPDF?', a: 'ISHU TOOLS offers all the same core PDF features as iLovePDF and SmallPDF — completely free, with no signup, no watermark, and no file limits. Plus, ISHU TOOLS has 715+ additional tools including Indian-specific calculators (SIP, EMI, GST), UPI QR Generator, CGPA Converter, and government exam photo resizers.' },
  ...
  { q: 'ISHU TOOLS ka full form kya hai?', a: 'ISHU TOOLS ka full form hai: Indian Student Hub University Tools. Yeh ek free online platform hai jisme 715+ tools hain — PDF, image, calculator, developer aur student tools ke liye. Ise Ishu Kumar ne banaya hai jo IIT Patna ke student hain. Bilkul free, koi signup nahi, koi watermark nahi.' },
]
      ...
      <section style={{ textAlign: 'center', padding: '80px 24px 64px', position: 'relative', overflow: 'hidden' }}>
        ...
        >
          <span style={{
            ...
            <Star size={12} fill="currentColor" /> 715+ Tools • 100% Free • No Signup
          </span>
        </motion.div>
        ...
        >
          ...
          >
            Explore All 715+ Tools <ArrowRight size={18} />
          </Link>
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          <motion.div {...fadeUp} style={{ textAlign: 'center', marginTop: 32 }}>
            <Link to="/tools" style={{
              ...
              View All 715+ Tools <ArrowRight size={16} />
            </Link>
          </motion.div>
        </div>
      </section>
      ...
      <section id="categories" style={{ padding: '64px 24px', maxWidth: 1280, margin: '0 auto' }}>
        <motion.div {...fadeUp} style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          <p style={{ color: 'var(--muted)', fontSize: 17, maxWidth: 560, margin: '0 auto' }}>
            38 categories, 715+ tools — everything you need, completely free
          </p>
        </motion.div>
